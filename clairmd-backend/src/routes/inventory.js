...
router.post("/", requireAuth, requireAccountType("individual_doctor"), async (req, res) => {
...
router.post("/:id/adjust", requireAuth, requireAccountType("individual_doctor"), async (req, res) => {
...
router.delete("/:id", requireAuth, requireAccountType("individual_doctor"), async (req, res) => {
  const result = await pool.query(
